...
create table Jewelry(
        ...
        cost varchar(200),orderid varchar(90) ,datapuchesed varchar(50),picture varchar(10000) ,
...
insert into Jewelry (
		id ,brand ,purchasedfrom,nameofitem ,cost,orderid ,datapuchesed,picture ,weight,
